...
Der Grund dafür liegt hauptsächlich an der redundanten Serververteilung und dem unstrukturierten Logging. 
...
Jede Anwendung ist auf zwei redundanten Servern installiert und schreibt auf dem jeweiligen Server ihre Logs. 
...
Den Fehler in den Logdateien zu finden, kann durch die fehlende Möglichkeit des Filterns sehr zeitaufwendig werden. \\
...
\begin{itemize}
    ...
    \item Können die Logging-Richtlinien aus der Projektarbeit in der Praxis umgesetzt werden? 
\end{itemize}
...
Anschließend sollen in der Applikationen \glqq Vierteljahreserklärung\grqq{} alle in der Projektarbeit definierten Richtlinien umgesetzt werden. 
