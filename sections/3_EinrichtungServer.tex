...
Nach der erfolgreichen Installation von Logstash wurde bei der Konfiguration festgestellt, dass die neu geschaffenen Logging-Richtlinien den Nutzen von Logstash vermindern. 
Der Vorteil von Logstash gegenüber Filebeat ist die Möglichkeit der Transformation der Logs. 
Mit Logstash können unstrukturierte Logdateien, anhand von Pipelines in eine strukturierte Form gebracht werden. \\ 
Durch die implementierten Logging-Richtlinien, besteht kein Nutzen für das Transformieren von Logdateien. 
...
In dem Szenario der Bachelorarbeit ist es somit nicht sinnvoll, Logstash zu installieren und zu konfigurieren.
Daher wurde auf die Einrichtung von Logstash verzichtet. \cite{elasticLogstashSammelnParsen}
