...
Für die produktiven Systeme werden RedHat Server genutzt, 
daher wird für den zentralisierten Logging-Server ebenfalls ein Redhat Server installiert.
...
Da es sich um einen RedHat Server handelt, werden \textit{rpm-Pakete} heruntergeladen und installiert.
