...
\section{Ablauf der Logs}
Ein bestimmtes Log raussuchen, zeigen und dann wie dieses Log in Kibana aussieht.
...
{ 
    "properties": 
    { 
        "time": "2021-01-20 14:14:41.0664", 
        "correlationId": "297c0eca-4692-433d-b649-de16db5a89b4", 
        "method": "KVWL.PortalVEAddInWeb.Controller
            .SessionController.GetBSNRsAsync", 
        "level": "Info", 
        "username": "TestPraesentation", 
        "message": "Aufruf der REST-Schnittstelle: GetBSNRsAsync 
            mit: quarter=1, year=2021", 
        "quarter": 1, 
        "year": 2021 
    } 
}
...
\begin{figure}[H]
    \center 
    \includegraphics[width=1\textwidth]{pictures/KibanaBearbeitet.PNG} 
    \caption{Kibana}
    \label{fig:prozessDanach}
\end{figure}
