...
Da fallen die Unterschiede der beiden Prozesse auf: Beim vorherigen Prozess musste sich mit einer Remotedesktopverbindung auf den entsprechenden Server zugeschaltet werden, beim aktuellen Prozess muss nur noch eine URL mit dem Browser aufgerufen werden. 
