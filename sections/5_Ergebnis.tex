...
Kritikpunkt war die nicht intuitive Nutzung von Kibana, die nicht ohne Einweisung genutzt werden kann. 
Beispielhaft kann der Unterpunkt \glqq Discover\grqq{} genannt werden. 
In \glqq Discover\grqq{} können die gesendeten Logs gesucht und gefiltert werden. 
Es ist in der Oberfläche nicht zu erahnen, dass die Logs sich in diesem Unterpunkt befinden. 
Trotz diesem Kritikpunkt fiel der erste Eindruck sehr positiv aus, denn nach einer kleinen Einführung in die neuen Produkte wurde deutlich, dass neue Möglichkeiten entstanden sind. 
Der neue Fehleranalyseprozess fällt deutlich geringer aus als der ehemalige. \\
...
Dafür muss die neue Konfigurationsdatei von NLog in die Anwendungen integriert und das passende NuGet-Package für NLog muss installiert werden. 
