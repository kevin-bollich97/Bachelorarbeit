...
Das bedeutet, dass das Tool eine Lösung bieten muss, die auf den Servern der KV läuft. \\
...
Jedoch möchte das Team das Tool gerne auf einem Linux-Server installieren, da dort das Updaten von neuen Versionen einfacher funktioniert und der Wissensstand des Teams da größer ist. \\
...
Die Graylog Enterprise Variante kann bis zu 5 GB/Tag kostenlos genutzt werden. 
Bei den 5 GB handelt es sich um Logs die gesendet werden. 
Für kleine Datenmengen ist es daher ratsam direkt auf die Enterprise Variante zu setzen. \cite{graylogGraylogOpenSource} \\
\begin{figure}[H]
    \center 
...
% VORRAUSSETZUNGEN
Graylog benötigt ein paar Systemvorraussetzungen, um installiert werden zu können. 
...
Die Datenströme im \glqq Before Fluentd\grqq{} Teil sind chaotisch und undstrukturiert, wobei mit der Nutzung von Fluentd die Datenströme einheitlich über Fluentd laufen. \Cite{fluentdFluentdOpenSource} \\
