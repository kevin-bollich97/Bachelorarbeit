...
Jedoch erhält man durch den Erwerb der Enterprise Version mehr Funktionen als die kostenlose Version des Elastic Stack. \\
...
Daher wird im Rahmen dieser Bachelorarbeit der Elastic Stack installiert und getestet.
In Tabelle \ref{tab:vergleichLogTools} ist eine Auflistung der getesteten Tools mit relevanten Anforderungen. 
...
\begin{table}[H]
    ...
    \textbf{Open Source}                                                       & Ja                                                                & Ja                                                                         & Nein                                                                 & Ja               \\ \hline
    ...
    \textbf{Log-Agent}                                                         & Ja, Filebeat                                                      & \begin{tabular}[c]{@{}l@{}}Nein, \\ Filebeat\\ empholen\end{tabular}       & Nein                                                                 & Nein             \\ \hline
    \textbf{Wartungsaufwand}                                                   & Hoch                                                              & Mittel                                                                     & Niedrig                                                              & Niedrig          \\ \hline
    \textbf{Installation}                                                      & \begin{tabular}[c]{@{}l@{}}Linux,\\ Windows,\\ MacOS\end{tabular} & OVA, rpm,                                                                  & \begin{tabular}[c]{@{}l@{}}Docker und\\ Kubernetes\end{tabular}      &                  \\ \hline
    \end{tabular}
