...
Daher werden die Daten in DTOs (Data Transfer Objects) geladen werden, um die Menge an HTTP-Anfragen zu reduzieren. 
...
Das Log, dass mit diesem Aufruf geschrieben wird, enthält der Inhalt einer Variable. 
